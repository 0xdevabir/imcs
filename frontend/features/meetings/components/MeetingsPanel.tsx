...
export function MeetingsPanel({ darkMode }: MeetingsPanelProps) {
  ...
  return (
    <div className={`h-full flex flex-col overflow-hidden ${
      ...
      {/* Header */}
      <div className={`flex-shrink-0 border-b px-6 pt-6 pb-5 ${
        ...
        <div className="flex items-center justify-between mb-5">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-semibold text-white bg-blue-600 hover:bg-blue-500 transition-all duration-150 active:scale-95 shadow-sm shadow-blue-500/25"
            >
              <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex items-end gap-2 pb-0.5">
                <button
                  ...
                  className="px-4 py-2 rounded-xl text-sm font-semibold text-white bg-blue-600 hover:bg-blue-500 disabled:opacity-50 disabled:cursor-not-allowed transition-all active:scale-95"
                >
                  Start
                </button>
                <button
      ...
      <div className="flex items-start justify-between gap-3">
        <div className="flex items-start gap-3 min-w-0">
          ...
          <div className="min-w-0 flex-1">
            ...
            <div className={`flex items-center gap-3 mt-1 text-xs ${darkMode ? 'text-slate-500' : 'text-slate-500'}`}>
              ...
              <div className="flex items-center">
                {meeting.participants.slice(0, maxAvatars).map((p, i) => (
                  <div
                    key={p}
                    title={p}
                    className={`w-5 h-5 rounded-full bg-gradient-to-br ${avatarGradient(p)} flex items-center justify-center text-[8px] font-bold text-white ring-2 ${darkMode ? 'ring-slate-900' : 'ring-white'} -ml-${i > 0 ? '1.5' : '0'}`}
            ...
            {/* Meeting ID */}
            <div className={`mt-2 flex items-center gap-1.5 font-mono text-[11px] ${darkMode ? 'text-slate-600' : 'text-slate-400'}`}>
        ...
        {!isEnded && (
          <button
            ...
            className={`flex-shrink-0 flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-xs font-semibold transition-all duration-150 active:scale-95 ${
              isLive
